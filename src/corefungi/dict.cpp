...
namespace corefungi {
  ...
  corefungi::ref_dict items(corefungi::node& node) {
    return corefungi::transform(boost::get< corefungi::dict >(node),
                                std::function< corefungi::ref_pair(dict::value_type&) > {
                                  [](dict::value_type& v) -> corefungi::ref_pair {
  ...
  corefungi::spore_list keys(corefungi::node& node) {
    return corefungi::transform(boost::get< corefungi::dict >(node),
                                std::function< corefungi::spore(dict::value_type&) > {
                                  [](dict::value_type& v) -> corefungi::spore {
                                    return v.first;
                                  }
                                });
  }
  ...
  corefungi::ref_list values(corefungi::node& node) {
    return corefungi::transform(boost::get< corefungi::dict >(node),
                                std::function< corefungi::node_ref(dict::value_type&) > {
                                  [](dict::value_type& v) -> corefungi::node_ref {
                                    return v.second;
                                  }
                                });
  }
