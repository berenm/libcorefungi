...
namespace std {
  ...
  namespace detail {
    ...
    template < typename T > struct delimiters< T, sequence_container > {
      static constexpr char begin     = '[';
      static constexpr char end       = ']';
      static constexpr char separator = ',';
    };

    template < typename T > struct delimiters< T, associative_container > {
      static constexpr char begin     = '{';
      static constexpr char end       = '}';
      static constexpr char separator = ',';
    };

    template < typename T > struct delimiters< T, collection_container > {
      static constexpr char begin     = '(';
      static constexpr char end       = ')';
      static constexpr char separator = ',';
    };
...
#define STL_OSTREAM_DECLARE_CONTAINER_TYPE(container_m, type_m) \
  ...
  struct container_type< container_m< Types... > > {            \
    typedef type_m type;                                        \
  }
    ...
    STL_OSTREAM_DECLARE_CONTAINER_TYPE(std::unordered_set,
                                       associative_container);
    STL_OSTREAM_DECLARE_CONTAINER_TYPE(std::unordered_multiset,
                                       associative_container);
    STL_OSTREAM_DECLARE_CONTAINER_TYPE(std::unordered_map,
                                       associative_container);
    STL_OSTREAM_DECLARE_CONTAINER_TYPE(std::unordered_multimap,
                                       associative_container);
...
#undef STL_OSTREAM_DECLARE_CONTAINER_TYPE
    ...
    template < std::size_t const N, typename... Types > struct tuple_printer {
      template < typename S >
      static inline void print(S& s, std::tuple< Types... > const& t) {
        detail::tuple_printer< N - 1, Types... >::print(s, t);

        s << detail::delimiters< std::tuple< Types... > >::separator << ' '
          << std::get< N >(t);
      }
    };

    template < typename... Types > struct tuple_printer< 0, Types... > {
      template < typename S >
      static inline void print(S& s, std::tuple< Types... > const& t) {
        s << std::get< 0 >(t);
      }
  ...
  template < typename C, typename T = typename C::value_type,
             typename Type = typename detail::container_type< C >::type,
             typename Cr, typename Tr >
  static inline std::basic_ostream< Cr, Tr >& operator<<(
    std::basic_ostream< Cr, Tr >& s, C const& v) {
    ...
    for (T const& t : v) {
      if (&t != &f) s << detail::delimiters< C >::separator << ' ';
      s << t;
    }
  ...
  static inline std::basic_ostream< Cr, Tr >& operator<<(
    std::basic_ostream< Cr, Tr >& s, std::pair< K, V > const& p) {
    s << p.first << ": " << p.second;
  ...
  static inline std::basic_ostream< Cr, Tr >& operator<<(
    std::basic_ostream< Cr, Tr >& s, std::tuple< Types... > const& t) {
  ...
  static inline std::basic_ostream< Cr, Tr >& operator<<(
    std::basic_ostream< Cr, Tr >& s, std::bitset< S > const& b) {
    s << b.to_string();
  ...
  static inline std::basic_ostream< Cr, Tr >& operator<<(
    std::basic_ostream< Cr, Tr >& s, std::function< R(Args...) > const& f) {
    s << reinterpret_cast< void const* >(
      *f.template target< R (*)(Args...) >());
