...
template <typename C, typename T = typename C::value_type,
          typename Type = typename detail::container_type<C>::type, typename Cr,
          typename Tr>
static inline std::basic_ostream<Cr, Tr>&
operator<<(std::basic_ostream<Cr, Tr>& s, C const& v) {
...
static inline std::basic_ostream<Cr, Tr>&
operator<<(std::basic_ostream<Cr, Tr>& s, std::pair<K, V> const& p) {
  s << p.first << ": " << p.second;
...
static inline std::basic_ostream<Cr, Tr>&
operator<<(std::basic_ostream<Cr, Tr>& s, std::tuple<Types...> const& t) {
...
static inline std::basic_ostream<Cr, Tr>&
operator<<(std::basic_ostream<Cr, Tr>& s, std::bitset<S> const& b) {
  s << b.to_string();
...
static inline std::basic_ostream<Cr, Tr>&
operator<<(std::basic_ostream<Cr, Tr>& s, std::function<R(Args...)> const& f) {
